...
DATASETS = [
    {
        "name": "bluebikes",
        "raw_path": os.path.join("/opt/airflow", "data", "raw", "bluebikes"),
        "processed_path": os.path.join("/opt/airflow", "data", "processed", "bluebikes"),
        "preprocessing": {
    ...
    {
        "name": "boston_clg",
        "raw_path": os.path.join("/opt/airflow", "data", "raw", "boston_clg"),
        "processed_path": os.path.join("/opt/airflow", "data", "processed", "boston_clg"),
        "preprocessing": {
            "missing_config": {
                "fill_strategies": {
                    "Cost": "median",
    ...
    {
        "name": "NOAA_weather",
        "raw_path": os.path.join("/opt/airflow", "data", "raw", "NOAA_weather"),
        "processed_path": os.path.join("/opt/airflow", "data", "processed", "NOAA_weather"),
        "preprocessing": {
            "missing_config": {
                "fill_strategies": {
                    "PRCP": "median",
